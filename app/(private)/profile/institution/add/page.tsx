...
const InstitutionAddPage = () => {
  ...
  const onSubmit = async (values: FormSchemaType) => {
    try {
      ...
      router.push("/profile/institution");
    } catch (error) {
      console.log(error);
  ...
  return (
    <div className="max-w-4xl bg-white p-4 md:p-6 ">
      ...
      <div className="flex items-center justify-end gap-x-4">
        <Button
          ...
          variant="secondary"
          onClick={() => router.push("/profile/institution")}
        >
...
export default InstitutionAddPage;
